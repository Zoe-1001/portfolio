    ...
    class ReviewxAdmin extends Controller
    {
        ...
        */
        ...
        public function rx_export_review() {
            ...
            $filter_field       = rest_sanitize_array($_POST['filterValue']);
            $selected_column    = rest_sanitize_array($_POST['selectedColumns']);
            $change_column      = rest_sanitize_array($_POST['changeColumnName']);
        ...
        // google revie function 
        // public function rx_google_review_from() {
        //     $rx_google_review = $_POST['rx_review_id'];
        //     var_dump($rx_google_review);
        //     wp_send_json("Hello review", $rx_google_review);
        // }
    }
